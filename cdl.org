...
#+begin_src R :tangle aeaGrid.R
  ...
  cdlProj <- ogrInfo( "shp/cdl.shp", "cdl")$p4s
  ...
  system( sprintf( "gdalwarp -overwrite -t_srs %s -tr 56 56 -tap -ot UInt32 -dstnodata 0 -multi mask/cdlCells.tif mask/cdlCellsAea.tif", cdlProj))
